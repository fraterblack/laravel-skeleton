...
return [
    ...
    "required_unless"  => "O campo :attribute é obrigatório a não ser que o valor do campo :other é igual a :value.",
    ...
    "image_dimensions" => "A imagem do campo :attribute não possuí as dimensões corretas.",
